...
class TestCV(unittest.TestCase):
    def test_cv_requirements(self):
        required_sections = ['Personal Details', 'Objective', 'Education',
                             'Work Experience', 'Skills', 'Interests and Hobbies', 'References']
        cv_directory = 'cv/'
            ...
            with self.subTest(cv_file=cv_file):
                ...
                with open(cv_path, 'r') as file:
                    ...
                    for section in required_sections:
                        ...
                        pattern = re.compile(
                            fr'^#\s*{re.escape(section)}\s*$', re.IGNORECASE | re.MULTILINE)
